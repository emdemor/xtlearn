"""
The :mod:`sklearn.visualization._classification` includes function to plot some useful
graphs to classification problems.
"""

# Author: Eduardo Messias de Morais <emdemor415@gmail.com>
...
def roc_auc_plot(
    ...
    logging.info("ROC AUC: %.3f" % (lr_auc))
